...
MEDIA_AUDIO_FEED_LEAD_MS ?= 1000
MEDIA_VIDEO_LOWRES_AUDIO_FEED_LEAD_MS ?= 1500
...
MEDIA_AUDIO_MAX_HW_AHEAD_MS ?= 3000
MEDIA_VIDEO_MAX_HW_AHEAD_MS ?= 3000
...
CONFIG_DEFINES := \
	...
	-DUNIFROG_MEDIA_VIDEO_LOWRES_AUDIO_FEED_LEAD_MS=$(MEDIA_VIDEO_LOWRES_AUDIO_FEED_LEAD_MS) \
...
help:
	...
	@echo "  make MEDIA_AUDIO_FEED_LEAD_MS=1000  Tune hardware audio feed lead"
	@echo "  make MEDIA_VIDEO_LOWRES_AUDIO_FEED_LEAD_MS=1500  Tune low-res video audio cushion"
...
print-config:
	...
	@echo "MEDIA_VIDEO_LOWRES_AUDIO_FEED_LEAD_MS=$(MEDIA_VIDEO_LOWRES_AUDIO_FEED_LEAD_MS)"
