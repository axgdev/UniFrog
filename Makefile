...
CONFIG_DEFINES := \
	...
	-DUNIFROG_MEDIA_PROGRESS_OVERLAY=$(MEDIA_PROGRESS_OVERLAY)
...
help:
	...
	@echo "  make MEDIA_PROGRESS_OVERLAY=0  Disable media progress/seek overlay"
...
print-config:
	...
	@echo "MEDIA_PROGRESS_OVERLAY=$(MEDIA_PROGRESS_OVERLAY)"
