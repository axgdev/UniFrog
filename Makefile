...
MEDIA_VIDEO_READAHEAD_SIZE ?= 1048576
MEDIA_VIDEO_READAHEAD_MIN_SIZE ?= 524288
MEDIA_VIDEO_READAHEAD_SLOTS ?= 4
...
help:
	...
	@echo "  make MEDIA_VIDEO_READAHEAD_SIZE=1048576  Tune video SD read window bytes"
	@echo "  make MEDIA_VIDEO_READAHEAD_SLOTS=4  Tune retained video read windows"
