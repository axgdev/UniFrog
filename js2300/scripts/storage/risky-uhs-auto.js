...
JS2300.video.text(14, 52, "uhs", 0xbdf7);
JS2300.video.text(14, 206, "May require a power cycle", 0x7bef);
JS2300.video.present();
var ret = JS2300.system.action("developer:storage_stress:uhs");
JS2300.log("storage risky profile=uhs ret=" + ret);
if (ret <= 0)
  throw new Error("uhs failed");
