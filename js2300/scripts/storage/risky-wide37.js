...
JS2300.video.text(14, 52, "wide37", 0xbdf7);
JS2300.video.text(14, 206, "May require a power cycle", 0x7bef);
JS2300.video.present();
var ret = JS2300.system.action("developer:storage_stress:wide37");
JS2300.log("storage risky profile=wide37 ret=" + ret);
if (ret <= 0)
  throw new Error("wide37 failed");
