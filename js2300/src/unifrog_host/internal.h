...
#define JS2300_FRONTEND_STORAGE_QUICK_MODES_REPORT \
   UNIFROG_REPORT_ROOT "/storage-quick-modes.txt"
#define JS2300_FRONTEND_STORAGE_SPEED_MATRIX_REPORT \
   UNIFROG_REPORT_ROOT "/storage-speed-matrix.txt"
