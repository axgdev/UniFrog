...
extern int unifrog_abi_application_memory_reserve_top_trampoline(
   size_t bytes, size_t alignment, void **out_ptr);
extern void unifrog_abi_application_memory_release_top_trampoline(void *ptr);
...
static const struct unifrog_abi unifrog_abi_table = {
   ...
   .application_memory_reserve_top =
      unifrog_abi_application_memory_reserve_top_trampoline,
   .application_memory_release_top =
      unifrog_abi_application_memory_release_top_trampoline,
};
