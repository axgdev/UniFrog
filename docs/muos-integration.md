...
The device frontend is UniFrog code that can read MuOS-style theme
...
The frontend is the boot frontend. The launcher exposes Explore,
Collection, History, Apps, Info, Config, Reboot, and Shutdown entries.
