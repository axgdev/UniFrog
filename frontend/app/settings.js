...
function writeUserOptions() {
  ...
  text += "language=" + config.language + "\n";
  text += "### [font] :[" + config.font + "] :[NotoSans-Regular|NotoSansArabic|NotoSansDevanagari|NotoSansBengali|NotoSansTamil|NotoSansTelugu|NotoSansCJKjp|NotoSansCJKsc|DroidSansFallback]\n";
  text += "font=" + config.font + "\n";
